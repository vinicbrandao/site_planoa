...
import { Bar, BarChart, CartesianGrid, XAxis, YAxis, LineChart, Line, RadialBar, RadialBarChart, PolarAngleAxis, LabelList, Cell } from "recharts";
...
const obrasData2026 = [
  { month: "Jan/26", previsto: 1, realizado: 2, textPrevisto: "1%", textRealizado: "2%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Fev/26", previsto: 2, realizado: 2, textPrevisto: "2%", textRealizado: "2%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Mar/26", previsto: 2, realizado: 3, textPrevisto: "2%", textRealizado: "3%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Abr/26", previsto: 3, realizado: 2, textPrevisto: "3%", textRealizado: "2%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Mai/26", previsto: 3, realizado: 3, textPrevisto: "3%", textRealizado: "3%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Jun/26", previsto: 4, realizado: 3, textPrevisto: "4%", textRealizado: "3%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Jul/26", previsto: 4, realizado: 4, textPrevisto: "4%", textRealizado: "4%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Ago/26", previsto: 5, realizado: 4, textPrevisto: "5%", textRealizado: "4%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Set/26", previsto: 5, realizado: 5, textPrevisto: "5%", textRealizado: "5%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Out/26", previsto: 4, realizado: 5, textPrevisto: "4%", textRealizado: "5%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Nov/26", previsto: 4, realizado: 5, textPrevisto: "4%", textRealizado: "5%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Dez/26", previsto: 3, realizado: 4, textPrevisto: "3%", textRealizado: "4%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
];

const obrasData2027 = [
  { month: "Jan/27", previsto: 1, realizado: 2, textPrevisto: "1%", textRealizado: "2%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Fev/27", previsto: 2, realizado: 3, textPrevisto: "2%", textRealizado: "3%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Mar/27", previsto: 2, realizado: 3, textPrevisto: "2%", textRealizado: "3%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Abr/27", previsto: 3, realizado: 2, textPrevisto: "3%", textRealizado: "2%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Mai/27", previsto: 4, realizado: 3, textPrevisto: "4%", textRealizado: "3%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Jun/27", previsto: 4, realizado: 4, textPrevisto: "4%", textRealizado: "4%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Jul/27", previsto: 5, realizado: 4, textPrevisto: "5%", textRealizado: "4%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Ago/27", previsto: 4, realizado: 5, textPrevisto: "4%", textRealizado: "5%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Set/27", previsto: 4, realizado: 5, textPrevisto: "4%", textRealizado: "5%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Out/27", previsto: 3, realizado: 5, textPrevisto: "3%", textRealizado: "5%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Nov/27", previsto: 3, realizado: 4, textPrevisto: "3%", textRealizado: "4%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Dez/27", previsto: 2, realizado: 4, textPrevisto: "2%", textRealizado: "4%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
];

const obrasData2028 = [
  { month: "Jan/28", previsto: 2, realizado: 3, textPrevisto: "2%", textRealizado: "3%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Fev/28", previsto: 2, realizado: 3, textPrevisto: "2%", textRealizado: "3%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Mar/28", previsto: 3, realizado: 3, textPrevisto: "3%", textRealizado: "3%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Abr/28", previsto: 3, realizado: 3, textPrevisto: "3%", textRealizado: "3%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Mai/28", previsto: 4, realizado: 4, textPrevisto: "4%", textRealizado: "4%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Jun/28", previsto: 4, realizado: 4, textPrevisto: "4%", textRealizado: "4%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Jul/28", previsto: 5, realizado: 4, textPrevisto: "5%", textRealizado: "4%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Ago/28", previsto: 4, realizado: 5, textPrevisto: "4%", textRealizado: "5%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Set/28", previsto: 3, realizado: 5, textPrevisto: "3%", textRealizado: "5%", bgFill: "rgba(29, 78, 216, 0.5)", fgFill: "#3b82f6" },
  { month: "Out/28", previsto: 3, realizado: 4, textPrevisto: "3%", textRealizado: "4%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Nov/28", previsto: 2, realizado: 4, textPrevisto: "2%", textRealizado: "4%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
  { month: "Dez/28", previsto: 2, realizado: 3, textPrevisto: "2%", textRealizado: "3%", bgFill: "rgba(109, 40, 217, 0.5)", fgFill: "#8b5cf6" },
];
  const dadosPorAno = {
  "2026": obrasData2026,
...
const chartConfig = {
  ...
  eficiencia: { label: "Eficiência", color: "#3b82f6" },
} satisfies ChartConfig;

const chartConfig2 = {
  previsto: {
    label: "Previsto",
    color: "#ffffff", // Cor da legenda (ajuste se quiser mais escuro/claro)
  },
  realizado: {
    label: "Realizado",
    color: "#3b82f6", // Cor da legenda (ajuste se quiser mais escuro/claro)
  },
} satisfies ChartConfig;
...
const DoubleBar = (props: any) => {
  ...
  // Barra de fundo (Previsto) — larga
  const bgW = width;
  const bgX = x;

  // Barra da frente (Realizado) — estreita, centralizada sobre a de fundo
  const fgW = Math.round(bgW * 0.58);
  const fgX = bgX + (bgW - fgW) / 2;
  const fgH = Math.round(height * (payload.realizado / payload.previsto));
  const fgY = y + height - fgH;

  return (
    <g>
      {/* Barra de fundo (Previsto) */}
      <rect
        x={bgX}
        y={y}
        width={bgW}
        ...
        strokeWidth={1}
      />
      {/* Valor do Previsto — acima da barra */}
      <text
        x={bgX + bgW / 2}
        y={y - 10}
        textAnchor="middle"
      ...
      <rect
        ...
        strokeWidth={1}
      />
      {/* Valor do Realizado — centralizado dentro da barra da frente */}
      {fgH > 20 && (
        <text
          x={fgX + fgW / 2}
          y={fgY + fgH / 2}
  ...
  return (
    <div className="flex flex-col h-full bg-[#080818] relative w-full items-center">
      <div className="p-8 flex-1 overflow-y-auto w-full pt-6 max-w-7xl">
        ...
        {/* CARD COM GRÁFICO DE BARRAS SOBREPOSTAS */}
        <Card className="p-0 w-full max-w-6xl mx-auto shadow-lg bg-[#0D0D1F] border border-white/10 text-white rounded-xl mb-12 overflow-hidden flex flex-col">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 p-6">
            ...
            <div className="xl:col-span-2 flex flex-col">
              ...
              onValueChange={(value: "2026" | "2027" | "2028") => setAnoSelecionado(value)}
            >
              <SelectTrigger className="w-[98px] bg-[#1A1A2E] border-white/10 text-white font-bold text-lg h-9 cursor-pointer">
            ...
            <div className="h-[250px] w-full mt-4">
              <ChartContainer config={chartConfig} className="h-full w-full">
                ...
                >
                  ...
                  <ChartTooltip
                    cursor={false}
                    content={<ChartTooltipContent className="bg-[#1e1e2d] border-slate-800 text-white"/>}
                  />
                  <ChartLegend 
